      ...
      <Wrapper>
        <div>
          ...
          <div className="heading2">
            <a href="/class11S" style = {{padding : "15px" , color : "black" , fontSize : "29px" }}>CBSE</a>
            <a href="/class11SICSE" style = {{padding : "15px" , color : "black" ,fontWeight : "bold" , fontSize : "29px"}}>ICSE</a>
          </div>
          <br/>
          <br/>
