    ...
    <div>
      ...
      <Wrapper>
        ...
        <div className="heading2">
            <a href="/class12C" style = {{padding : "15px" , color : "black" , fontWeight : "bold" , fontSize : "29px" }}>CBSE</a>
            <a href="/class12CICSE" style = {{padding : "15px" , color : "black" ,fontWeight : "none" , fontSize : "29px"}}>ICSE</a>
          </div>
          <br/>
          <br/>
