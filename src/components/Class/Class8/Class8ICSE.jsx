      ...
      <Wrapper>
        <div>
          ...
          <div className="heading2">
            <a href="/class8" style = {{padding : "15px" , color : "black" , fontSize : "29px" }}>CBSE</a>
            <a href="/class8ICSE" style = {{padding : "15px" , color : "black" ,fontWeight : "bold" , fontSize : "29px"}}>ICSE</a>
          </div>
          <br/>
          <br/>
