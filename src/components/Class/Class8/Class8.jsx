...
import micro from "../../../Images/microorganisms.png";
      ...
      <Wrapper>
        <div>
          ...
          <div className="heading2">
            <a href="/class8" style = {{padding : "15px" , color : "black" , fontWeight : "bold" , fontSize : "29px" }}>CBSE</a>
            <a href="/class8ICSE" style = {{padding : "15px" , color : "black" ,fontWeight : "none" , fontSize : "29px"}}>ICSE</a>
          </div>
          <br/>
          <br/>
...
<div class="row">
<div class="col-md-8">
                            <h4>Make a list of important concepts</h4>
                                        <h4 class="subheading">The first and most easy trick which helps the most is to begin by making a list of all the important concepts and formulae for quick reference and revision.</h4>
                        <p class="text-muted">By listing, you won’t skip any important topic, and would be able to revise each and every subtopic and concepts easily. Also, you can recall your prepared concepts just by having a look at the list.</p>
                        </div>
                    ...
                    <div class="row">
                    <div class="col-md-8">
                            <h4>Try to Write more</h4>
                                        <h4 class="subheading">You get to know your speed of writing, and accordingly adjust during the examination.</h4>
                                        <p class="text-muted">Study your concepts thoroughly, but make sure that you can write what you read. According to the proven fact, writing helps to remember any concept for a longer time, more than only by reading. Writing gives you practice, improves your answering style and gives you an idea on how to frame your answers.</p>
                        </div>
                        <div class="col-md-4 how-img">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h4>Prepare according to subject</h4>
                                        <h4 class="subheading">Different subjects need different types of preparation</h4>
                                        <p class="text-muted"> For instance, Mathematics is the one which involves plotting of Graphs, solving as many linear equations, Geometry concepts, and of Course the formulae. These involve a proper understanding of the concept and practice accordingly.

Science is the subject of diagrams and explanations. Therefore, make sure the diagram which needs to be represented is as neat and clear as possible, and properly labeled. And during the explanation, make points to explain each and every labeled part, such as digestive system, respiratory system and so on.</p>
                        </div>
                        <div class="col-md-4 how-img">
