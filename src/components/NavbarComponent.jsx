...
>>>>>>> 5c426b76e5ce36ddde369816b11d77406265a9d7
        ...
        <div class="row">
          <Navbar center bg="dark" expand="lg" className="navbar-expand-sm">
            ...
            <Navbar.Collapse id="basic-navbar-nav navbar-left">
                  ...
                  <li>
                    ...
                    <ul class="mega-dropdown mr-auto">
                      <li class="row">
                        <ul class="mega-col">
                          <li>
                            <Nav.Link href="#action/3.1" className="link">
                              Class 8
                            </Nav.Link>
                          </li>
                          <li>
                            <Nav.Link href="#action/3.2" className="link">
                              Class 9
                            </Nav.Link>
                          </li>
                        </ul>
                        <ul class="mega-col">
                          <li>
                            <Nav.Link href="#action/3.3" className="link">
                              Class 10
                            </Nav.Link>
                          </li>
                          <li>
                            <Nav.Link href="#action/3.4" className="link">
                              Class 11 Science
                            </Nav.Link>
                          </li>
                          <li>
                            <Nav.Link href="#action/3.5" className="link">
                              Class 12 Science
                            </Nav.Link>
                          </li>
                        </ul>
                        <ul class="mega-col">
                          <li>
                            <Nav.Link href="#action/3.6" className="link">
                              Class 11 Commerce
                            </Nav.Link>
                          </li>
                          <li>
                            <Nav.Link href="#action/3.7" className="link">
                              Class 12 Commerce
                            </Nav.Link>
                          </li>
                        </ul>
              ...
              {currentUser !== null ? (
                <Link to="/" className="btn login-btn mr-2" role="button">
                  <button
