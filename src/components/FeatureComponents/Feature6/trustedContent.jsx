        ...
        <div>
            ...
            <div className="row">
              ...
              >
                ...
                <p className=" abovep">
                  ...
                  convenience. You can sit anywhere and learn at any time.
                </p>
              </div>
              <div
            ...
            <div className="row">
              ...
              >
                ...
                <p className=" abovep">
                  ...
                  not only keep them stuck to the books but also make them aware
                  of the surrounded world. We make learning a fun session.
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            style={{
              marginTop: "10%",
              background:
                "linear-gradient(297.17deg, #B06AB3 6.67%, #4568DC 91.82%)",
              paddingBottom: "40px",
              height: "400px",
              border: "none",
              boxShadow: "none",
          ...
          <div className="card-deck">
            ...
            <div className="card mb-4 col-lg-3 center col-md-6 col-12 mt-4" style={{borderRadius: '30px'}} data-aos="zoom-in-up" data-aos-duration={2500}>
              <a href="/feature1"><img className="card-img-top  mx-auto image-4 " style={{paddingTop: '30px', marginTop: '20px', marginBottom: '70px'}} src={engg_ass} alt="" /></a>
              <div className="card-block ">
                <h4 className="card-title text-center card-four  ct-1" >Engaging Assignments</h4>
              </div>
            </div>
...
const Wrapper = styled.div`
  ...
  .jumbotron {
    ...
    bottom: 51.17%;
    text-align: center;
    background: linear-gradient(297.17deg, #b06ab3 6.67%, #4568dc 91.82%);
