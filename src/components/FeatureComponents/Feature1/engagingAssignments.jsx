        ...
        <Wrapper>
          ...
          <div className="container">
            <svg viewBox="0 0 1500 100">
              {/* Symbol*/}
              <symbol id="s-text">
                <text textAnchor="middle" x="50%" y="70%" dy=".35em">GET RID OF MONTONOUS BOOKS!</text>
              </symbol>
              {/* Duplicate symbols*/}
          ...
          <br />
          <br /><br /><br /><br /><br />
          <div className="card" style={{marginTop: '10%', background: 'linear-gradient(297.17deg, #FF512F 6.67%, #DD2476 91.82%)', paddingBottom: '40px', height: '400px', border: 'none', boxShadow: 'none'}}>
            <br />
...
export default engagingAssignments;    
...
body{
  ...
  .jumbotron{
    ...
    margin:0 auto;
      ...
      bottom: 51.17%;
     text-align: center;
      background:linear-gradient(297.17deg, #FF512F 6.67%, #DD2476 91.82%);
